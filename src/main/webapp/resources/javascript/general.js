...
function menu(){
    ...
    html = html +'<ul>'
    html = html +'<li><a href="/studentManagementMock/classform">Class Registration</a></li>';
    html = html +'<li><a href="/studentManagementMock/searchstudent">Student Search</a></li>';
    html = html +'<li><a href="/studentManagementMock/addstudent">Student Registration</a></li>';
    html = html +'</ul>';
    html = html +'</li>';
    html = html +'<li id="no-child">';
    html = html +'<a href="/studentManagementMock/usersearch" style="font-weight:bold;">User Management</a>';
    html = html +'</li>';
    html = html +'</ul>';
    html = html +'</div>';
